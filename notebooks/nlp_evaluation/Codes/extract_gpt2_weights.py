...
It downloads the GPT-2 124M checkpoint via TensorFlow, flattens every
...
# ── 1. Download raw checkpoint files (same logic as gpt_download3.py) ──────
MODEL_SIZE  = "124M"
MODELS_DIR  = "gpt2"
...
OUTPUT_NPZ  = os.path.join(MODELS_DIR, "gpt2_124M_weights.npz")
...
print("=== Downloading GPT-2 124M checkpoint ===")
for fn in FILENAMES:
...
flat = {}   # key -> numpy array, e.g. "blocks/0/attn/c_attn/w"
